"""
Submission/inference entrypoint for version 5.
...
from model import AUX_DIM, MASK_WARMUP_STEPS, NUM_CHANNELS, CNNActorCriticV5, prepare_policy_inputs, to_env_action
...
class Agent:
    def __init__(self, agent_id: int):
        ...
        self.model = CNNActorCriticV5(num_actions=6)
