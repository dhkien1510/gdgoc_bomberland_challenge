...
_MODEL_V3_SPEC = importlib.util.spec_from_file_location(
    "_v6_2_model_v3_base_train_base", _HERE / "_model_v3_base.py"
)
...
_SPEC = importlib.util.spec_from_file_location("_v6_2_train_base_v5_1", _BASE_PATH)
...
CURRICULUM_STAGES = [
    {
        "name": "farm_box_safe",
        "end_step": 350_000,
        "baseline_bots": [(SimpleRuleAgent, 0.55), (BoxFarmerAgent, 0.35), (SmarterRuleAgent, 0.10)],
        "selfplay_prob": 0.0,
        "reward": {
            **ITEM_REWARD_COMMON,
            "step_penalty": -0.008,
            ...
            "r_danger_soon": -0.06,
            "r_danger_far": -0.015,
            "r_escape_danger": 0.025,
            "r_valuable_bomb_enemy": 0.08,
            "r_valuable_bomb_box": 0.06,
            "r_useless_bomb": -0.10,
            "r_no_escape_bomb": -0.42,
            "rank_rewards": {0: 0.55, 1: 0.12, 2: -0.12, 3: -0.45},
            "r_move_closer_bomb_spot": 0.005,
            "r_move_away_bomb_spot": -0.001,
            "r_best_bomb_spot_dist": 0.015,
            "r_position_loop": -0.02,
            "r_item_capacity": 0.18,
            "r_item_radius": 0.20,
            "r_item_other": 0.04,
            "r_safe_item_progress_coef": 0.010,
            "r_safe_item_progress_clip": 0.020,
            "r_near_item_progress": 0.03,
            "r_near_item_wrong_way": -0.008,
            "r_ignore_near_safe_item": -0.01,
            "r_contested_item_progress_bonus": 0.0,
            "r_contested_item_take_bonus": 0.0,
            "r_destroy_item_capacity": -0.12,
            "r_destroy_item_radius": -0.14,
            "r_destroy_item_other": -0.04,
            "near_safe_item_dist": 3,
            "item_priority_dist": 3,
        },
    },
    {
