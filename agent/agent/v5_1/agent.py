"""
Submission/inference entrypoint for version 5.1.
...
from model import AUX_DIM, MASK_WARMUP_STEPS, NUM_CHANNELS, CNNActorCriticV5_1, prepare_policy_inputs, to_env_action
...
class Agent:
    def __init__(self, agent_id: int):
        ...
        self.model = CNNActorCriticV5_1(num_actions=6)
