"""
Submission/inference entrypoint for version 4.1.
...
from model import AUX_DIM, MASK_WARMUP_STEPS, NUM_CHANNELS, CNNActorCriticV4_1, prepare_policy_inputs, to_env_action
...
class Agent:
    def __init__(self, agent_id: int):
        ...
        self.model = CNNActorCriticV4_1(num_actions=6)
